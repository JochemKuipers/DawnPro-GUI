...
if __name__ == "__main__":
    assert convert_volume_to_payload(0) == 0xFF
    assert convert_volume_to_payload(60) == 0x00
    assert convert_volume_to_payload(99) == 0
    assert convert_volume_to_percent(0x00) == 60
    assert convert_gain_to_payload("High") == 1
    print("ok")
